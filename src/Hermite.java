...
public class Hermite {
	...
	static float[] y = new float[7];
	static float[] yP = new float[5];
	static float[] wynik = new float[6];
	static float[] wynikPoSumowaniu = new float[6];
	private static float[] wspolczynnikWielomianu = new float[5];
